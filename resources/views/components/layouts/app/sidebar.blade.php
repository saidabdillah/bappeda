    ...
    <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('SKBD')" class="grid">
                ...
                <flux:navlist.item icon="home" :href="route('karyawan.index')"
                    :current="request()->routeIs('karyawan.index')" wire:navigate>{{ __('Karyawan') }}
                </flux:navlist.item>
                <flux:navlist.item icon="home" :href="route('entry.create')"
